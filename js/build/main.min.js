...
!function(){var e=$(".navbar.sticky"),a=$(window).outerHeight()/4;$(window).on("scroll",function(){window.pageYOffset>a?e.addClass("sticked"):e.removeClass("sticked")})}(),function(){var e=Math.floor(11*Math.random()+1);$(".main-banner").parallax({imageSrc:"img/banner_bg"+e+".jpg"})}(),$("form.form-validate").on("submit",function(e){if(e.preventDefault(),e.stopPropagation(),!1===this.checkValidity())$(this).addClass("was-validated");else{var a=$(this),t=a.find(".overlay"),i=a.serialize(),r=a.attr("action"),n=a.find(".alert-success"),o=a.find(".alert-danger");t.removeClass("hide"),$.ajax({type:"POST",url:r,data:i}).done(function(e){o.addClass("hide"),o.attr("aria-hidden",!0),n.removeClass("hide"),n.attr("aria-hidden",!1),a.find(".form-control").each(function(){this.value=""})}).fail(function(e){n.addClass("hide"),n.attr("aria-hidden",!0),o.removeClass("hide"),o.attr("aria-hidden",!1),""!==e.responseText&&o.find(".alert-text").text(e.responseText)}),window.setTimeout(function(){t.addClass("hide"),a.removeClass("was-validated")},1e3)}}),function(){var e=$("#collapse-main-nav"),a=e.find(".navbar-nav");$("#main-nav").onePageNav({currentClass:"active",changeHash:!0,begin:function(){e.collapse("hide")},scrollChange:function(e){a.find(".nav-link[aria-describedby]").removeAttr("aria-describedby"),e.find("a").attr("aria-describedby","current-page")}})}(),$(".scroll-to").on("click",function(e){var a;if(e.preventDefault(),$(this).attr("href"))a=$($(this).attr("href"));else{if(!$(this).attr("data-target"))return!1;a=$($(this).attr("data-target"))}if(!a.length)return!1;var t=a.offset().top;window.scrollTo({top:t,behavior:"smooth"})}),window.sr=ScrollReveal({mobile:!1,delay:500,duration:1e3}),sr.reveal(".enter-left",{origin:"left",distance:"50vw"}),sr.reveal(".enter-left-delay",{origin:"left",distance:"50vw"},100),sr.reveal(".enter-right",{origin:"right",distance:"50vw"}),sr.reveal(".enter-right-delay",{origin:"right",distance:"50vw"},100),sr.reveal(".enter-bottom",{origin:"bottom",distance:"50vh"}),sr.reveal(".enter-bottom-close",{origin:"bottom",distance:"100%"}),sr.reveal(".enter-bottom-delay",{origin:"bottom",distance:"50vh"},100),sr.reveal(".enter-bottom-big-delay",{origin:"bottom",distance:"50px",duration:2e3,easing:"cubic-bezier(.06,.8,.88,.97)"},1e3);